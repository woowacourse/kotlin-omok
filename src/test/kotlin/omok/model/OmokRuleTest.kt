...
class OmokRuleTest {
    ...
    fun `3-3 정의 1`() {
        ...
        val actual1 = ThreeThreeChecker.checkThreeThree(3, 11) // D12 (3, 11)
    ...
    fun `3-3 정의 2`() {
        ...
        val actual2 = ThreeThreeChecker.checkThreeThree(4, 2) // E3 (4, 2)
    ...
    fun `3-3 정의 3`() {
        ...
        val actual3 = ThreeThreeChecker.checkThreeThree(11, 10) // L11 (11, 10)
    ...
    fun `3-3 정의 4`() {
        ...
        val actual4 = ThreeThreeChecker.checkThreeThree(10, 3) // K4 (10, 3)
