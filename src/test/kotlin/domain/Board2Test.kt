...
class Board2Test {
    ...
    fun `같은 위치에 바둑돌은 놓을 수 없다`() {
        ...
        val board = Board2(Stones(listOf(stone)))
    ...
    private fun generateThreeThreeBoard(): Board2 {
        val board = Board2().apply {
            placeStone(Stone(getCurrentTurn(), 2, 2))
    ...
    private fun generateFourFourBoard(): Board2 {
        val board = Board2().apply {
    ...
    private fun generateMoreFiveBoard(): Board2 {
        val board = Board2().apply {
