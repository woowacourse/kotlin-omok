...
class OmokBoardTest {
    ...
    fun `전진 방향과 현재 좌표를 입력하면 전진하려는 방향의 다음 좌표를 반환한다`() {
        ...
        assertThat(nextPoint).isEqualTo(Point(x = OmokColumn.H, y = OmokRow.NINE, stoneStatus = StoneStatus.EMPTY))
    }
    ...
    fun `전진 방향과 현재 좌표를 입력하면 전진하려는 방향의 다음 좌표를 반환한다2`() {
        ...
        assertThat(nextPoint).isEqualTo(Point(x = OmokColumn.G, y = OmokRow.TEN, stoneStatus = StoneStatus.EMPTY))
    }
    ...
    fun `전진 방향과 현재 좌표를 입력하면 전진하려는 방향의 다음 좌표를 반환한다3`() {
        ...
        assertThat(nextPoint).isEqualTo(Point(x = OmokColumn.G, y = OmokRow.ELEVEN, stoneStatus = StoneStatus.EMPTY))
    }
