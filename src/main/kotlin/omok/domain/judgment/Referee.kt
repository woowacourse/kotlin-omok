...
abstract class Referee {
    tailrec fun countNorthContinuity(board: Map<Position, Stone?>, position: Position, count: Int): Int {
    ...
    tailrec fun countNorthEastContinuity(board: Map<Position, Stone?>, position: Position, count: Int): Int {
    ...
    tailrec fun countEastContinuity(board: Map<Position, Stone?>, position: Position, count: Int): Int {
    ...
    tailrec fun countSouthEastContinuity(board: Map<Position, Stone?>, position: Position, count: Int): Int {
    ...
    tailrec fun countSouthContinuity(board: Map<Position, Stone?>, position: Position, count: Int): Int {
    ...
    tailrec fun countSouthWestContinuity(board: Map<Position, Stone?>, position: Position, count: Int): Int {
    ...
    tailrec fun countWestContinuity(board: Map<Position, Stone?>, position: Position, count: Int): Int {
    ...
    tailrec fun countNorthWestContinuity(board: Map<Position, Stone?>, position: Position, count: Int): Int {
