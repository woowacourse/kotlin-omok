...
class OtherForbiddenRule(private val board: List<List<Int>>, private val stoneState: Int) {
    ...
    private fun checkOpenThree(x: Int, y: Int, dx: Int, dy: Int): Int {
        ...
        return when {
            ...
            board[y - dy * (leftDown + 1)][x - dx * (leftDown + 1)] == nextStone -> 0
            board[y + dy * (rightUp + 1)][x + dx * (rightUp + 1)] == nextStone -> 0
            else -> 1
        }
    }
    ...
    private fun checkOpenThreeReverse(x: Int, y: Int, dx: Int, dy: Int): Int {
        ...
        return when {
            ...
            board[y - rightBottom - 1][x + rightBottom + 1] == nextStone -> 0
            board[y + leftUp + 1][x - leftUp - 1] == nextStone -> 0
            else -> 1
        }
    }
        ...
        while (true) {
            ...
            when (board[toTop][toRight]) {
                ...
                EMPTY_STONE -> {
                    ...
                    println("convertBoard[toTop][toRight] = ${board[toTop][toRight]}")
